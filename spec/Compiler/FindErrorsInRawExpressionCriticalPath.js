describe("FindErrorsInRawExpressionCriticalPath", () => {
    const Namespace = require("rewire")("../../Exports.js")
    const FindErrorsInRawExpressionCriticalPath = Namespace.__get__("FindErrorsInRawExpressionCriticalPath")

    function Test(description, input, output, findErrorsInRawExpressionCriticalPath, findErrorsInRawExpression) {
        describe(description, () => {
            beforeEach(() => Namespace.__set__("FindErrorsInRawExpressionCriticalPath", findErrorsInRawExpressionCriticalPath || fail))
            beforeEach(() => Namespace.__set__("FindErrorsInRawExpression", findErrorsInRawExpression || fail))
            it("returns the expected output", () => expect(FindErrorsInRawExpressionCriticalPath(input)).toEqual(output))
        })
    }
