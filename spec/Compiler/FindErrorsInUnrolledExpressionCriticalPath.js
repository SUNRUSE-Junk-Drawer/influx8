describe("FindErrorsInUnrolledExpressionCriticalPath", () => {
    const Namespace = require("rewire")("../../Exports.js")
    const FindErrorsInUnrolledExpressionCriticalPath = Namespace.__get__("FindErrorsInUnrolledExpressionCriticalPath")

    function Test(description, input, output, findErrorsInUnrolledExpressionCriticalPath, findErrorsInUnrolledExpression, findErrorsInInlinedExpression, findErrorsInRawExpression) {
        describe(description, () => {
            ...
            it("returns the expected output", () => expect(FindErrorsInUnrolledExpressionCriticalPath(input)).toEqual(output))
        })
    }
    ...
    Test("binary plurality inconsistent", {
    ...
    Test("lambda", {
        ...
        ], undefined, undefined, undefined, expression => {
    ...
    Test("call", {
        ...
        EndIndex: 32
            ...
            expect(["test argument a", "test argument b", "test argument c"]).toContain(expression)
            switch (expression) {
