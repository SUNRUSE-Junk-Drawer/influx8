describe("FindErrorsInInlinedExpressionCriticalPath", () => {
    const Namespace = require("rewire")("../../Exports.js")
    const FindErrorsInInlinedExpressionCriticalPath = Namespace.__get__("FindErrorsInInlinedExpressionCriticalPath")

    function Test(description, input, output, findErrorsInInlinedExpressionCriticalPath, findErrorsInInlinedExpression, findErrorsInRawExpression) {
        describe(description, () => {
            beforeEach(() => Namespace.__set__("FindErrorsInInlinedExpressionCriticalPath", findErrorsInInlinedExpressionCriticalPath || fail))
            ...
            it("returns the expected output", () => expect(FindErrorsInInlinedExpressionCriticalPath(input)).toEqual(output))
        })
    }
    ...
    Test("call", {
        ...
        EndIndex: 32
            ...
            expect(expression).toEqual("test argument")
            return [
                "test recursed argument a",
                "test recursed argument b",
                "test recursed argument c",
