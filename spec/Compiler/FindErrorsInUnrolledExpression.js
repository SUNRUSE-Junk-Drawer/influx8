describe("FindErrorsInUnrolledExpression", () => {
    const Namespace = require("rewire")("../../Exports.js")
    const FindErrorsInUnrolledExpression = Namespace.__get__("FindErrorsInUnrolledExpression")

    function Test(description, input, output, findErrorsInUnrolledExpression, findErrorsInInlinedExpression, findErrorsInRawExpression) {
        describe(description, () => {
            ...
            it("returns the expected output", () => expect(FindErrorsInUnrolledExpression(input)).toEqual(output))
        })
    }
