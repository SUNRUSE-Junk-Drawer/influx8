describe("FindErrorsInTypecheckedExpression", () => {
    const Namespace = require("rewire")("../../Exports.js")
    const FindErrorsInTypecheckedExpression = Namespace.__get__("FindErrorsInTypecheckedExpression")

    function Test(description, input, output, findErrorsInTypecheckedExpression, findErrorsInUnrolledExpressionCriticalPath, findErrorsInUnrolledExpression, findErrorsInInlinedExpression, findErrorsInRawExpression) {
        describe(description, () => {
            ...
            it("returns the expected output", () => expect(FindErrorsInTypecheckedExpression(input)).toEqual(output))
        })
    }
    ...
    Test("let", {
        ...
        Then: "test then"
            ...
            expect(["test value a", "test value b", "test value c", "test then"]).toContain(expression)
            switch (expression) {
