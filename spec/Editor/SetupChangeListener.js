describe("SetupChangeListener", () => {
    ...
    beforeEach(() => {
        ...
        StartBuild.and.callFake((editorElement, source, textAreaWrappingElement, throttle, worker, buildId, configuration) => {
    ...
    it("gives the build the editor element, source code text area wrapping element, throttle, worker, build id and configuration", () => expect(StartBuild).toHaveBeenCalledWith("test editor element", "test source code a", "test text area wrapping element", "test throttle", workerInstance, 0, configuration))
    ...
    describe("when the worker posts a message", () => {
        ...
        describe("on executing a textarea callback", () => {
            ...
            it("gives the build the editor element, source code and text area wrapping element, throttle, worker, build id and configuration", () => expect(StartBuild).toHaveBeenCalledWith("test editor element", "test source code b", "test text area wrapping element", "test throttle", workerInstance, 1, configuration))
            ...
            describe("on executing another textarea callback", () => {
                ...
                it("gives the build the editor element, source code and text area wrapping element, throttle, worker, build id and configuration", () => expect(StartBuild).toHaveBeenCalledWith("test editor element", "test source code c", "test text area wrapping element", "test throttle", workerInstance, 2, configuration))
                it("does not update another build", () => expect(UpdateBuild.calls.count()).toEqual(1))
                ...
                describe("on executing another textarea callback", () => {
                    ...
                    it("gives the build the editor element, source code and text area wrapping element, throttle, worker, build id and configuration", () => expect(StartBuild).toHaveBeenCalledWith("test editor element", "test source code d", "test text area wrapping element", "test throttle", workerInstance, 3, configuration))
                    it("does not update another build", () => expect(UpdateBuild.calls.count()).toEqual(1))
