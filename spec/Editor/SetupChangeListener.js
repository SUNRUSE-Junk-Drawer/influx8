describe("SetupChangeListener", () => {
    ...
    it("gives the build the editor element, source code and text area wrapping element", () => expect(StartBuild).toHaveBeenCalledWith("test editor element", "test source code a", "test text area wrapping element"))
    ...
    describe("on executing a callback", () => {
        ...
        it("gives the build the editor element, source code and text area wrapping element", () => expect(StartBuild).toHaveBeenCalledWith("test editor element", "test source code b", "test text area wrapping element"))
        ...
        describe("on executing another callback", () => {
            ...
            it("gives the build the editor element, source code and text area wrapping element", () => expect(StartBuild).toHaveBeenCalledWith("test editor element", "test source code c", "test text area wrapping element"))
            ...
            describe("on executing another callback", () => {
                ...
                it("gives the build the editor element, source code and text area wrapping element", () => expect(StartBuild).toHaveBeenCalledWith("test editor element", "test source code d", "test text area wrapping element"))
